...
public class OptionsScreen extends AppCompatActivity {
    ...
    private void createBoardSizeRadioButtons() {
        ...
        for(int i = 0; i<boardOptions.length; i++){
            ...
            button.setOnClickListener(v -> Toast
                    .makeText(OptionsScreen.this, "Board will be "+boardSize, Toast.LENGTH_SHORT)
                    .show());
    ...
    private void createMinesRadioButtons() {
        ...
        for(int i = 0; i<num_mines.length; i++){
            ...
            //TODO: Set on click callbacks
            button.setOnClickListener(v -> Toast
                    .makeText(OptionsScreen.this, "You selected "+numMine, Toast.LENGTH_SHORT)
                    .show());
